...
export function buildCorePrompt(
  ...
  return [
    ...
    "  3. File artifacts by KIND, never by writing loose files no one reads:",
    ...
    "         A handoff you did not verify did not happen: after minting a task",
    "         for another loop, re-run THAT loop's own query and see yours in it.",
    "       • prose to read as an artifact       → a doc (`doc put <key> --file`).",
    "         The doc is the HUMAN WINDOW: when a pass produces something a person",
    "         would want to see, publish it as a doc - not a loose file only you know.",
