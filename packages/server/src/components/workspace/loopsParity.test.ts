...
const loopView = {
  ...
  loop: {
    ...
    workdir: '/srv/backups', payload: {}, source: 'prod',
  },
  charter: { docId: 'doc-charter', key: `loop-charter:${ID}`, body: '## Spec\n\nVerify every backup.', version: 9, updatedAt: '2026-08-06T01:02:00.000Z', seeded: true },
