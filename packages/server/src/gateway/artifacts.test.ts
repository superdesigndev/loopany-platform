...
// hostile path carrying one must be dropped at validation, not allowed through
// to 500 a query on the row lookup. (No real filesystem can produce a NUL
// filename, so rejecting is always correct.)
