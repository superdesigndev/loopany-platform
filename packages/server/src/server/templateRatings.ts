...
export const TEMPLATE_RATINGS: Record<string, TemplateRating> = {
  ...
  'seo-try-keywords': {
    ...
    mechanism: 'open',
    visibility: 'compounds',
    visibilityNote: 'New-keyword bets score on position/impressions first; most are duds by design, and the winners compound over weeks.',
    schedule: "Weekly (your choice)",
    does: "Reads your radar → one cheap bet on one NEW keyword",
    outcome: "🔀 One new-keyword page cluster as a PR",
  },
  'seo-scale-keywords': {
    ease: 'moderate',
    cadence: 'short',
    mechanism: 'open',
    visibility: 'few-runs',
    visibilityNote: 'Each support page or fix lands within days; the position hold shows in the daily series over a couple of weeks.',
    schedule: "Every 2–3 days (your choice)",
    does: "Reads the proven keywords → one support page or fix",
    outcome: "🔀 One cluster-strengthening PR per run",
  },
